...
class SignatureVerifierPatch(Patch):
    ...
    def class_filter(self, class_data: str) -> bool:
        return "PackageManagerUtils/setActivityRegisteredState/error:" in class_data
